 ...
 */
public class TransactionsNotSupportedException extends TransactionException {

    private static final long serialVersionUID = 2811709773958015880L;

    public TransactionsNotSupportedException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public TransactionsNotSupportedException(Throwable cause) {
        super(cause);
    }
}
